...
#define VMV_RV(md, rs1, vs2) \
  __asm__ volatile(".insn r 0x57, 0x6, 0x55, " md ", %0, " vs2 : : "r"(rs1));

// opmvx. f6=b101110, f7=b1011101
#define VMV_VR(vd, rs1, ms2) \
  __asm__ volatile(".insn r 0x57, 0x6, 0x5d, " vd ", %0, " ms2 : : "r"(rs1));

// opmvx. f6=b101100, f7=b1011001
#define OPMVINBCAST(md, vs2) \
  __asm__ volatile(".insn r 0x57, 0x6, 0x59, " md ", x0, " vs2);

// opmvv. f6=b101000, f7=b1010001
#define VOPACC(md, vs2, vs1) \
  __asm__ volatile(".insn r 0x57, 0x2, 0x51, " md ", " vs1 ", " vs2);
